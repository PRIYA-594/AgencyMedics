...
<body>
    ...
    <div class="topnav">
        ...
        <a href="hospital4.php">HOSPITAL</a>
        <a class="dactive" href="Main.php">Exit</a>
        <div class="search-container">
        <form action="phpSearchDoctor.php" method="POST">
	...
	<main>
		...
		<table>
			<tr>
				...
				<td>
					<button id="exp" class="exp"><a href="innerDoctorDetails.php">Click Here To Update</a></button>
				</td>
            </tr>
		</table>
		</center>
