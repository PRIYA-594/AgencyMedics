...
$insert_data="insert into doctor(name,age,dob,mail,address,phone,gender,nation,religion,lnk,school,clg,qualification,file) values('$name','$age','$dob','$mail','$address','$phone','$gender','$nation','$religion','$lng','$school','$clg','$Qual','$file');";
