...
<body>
    ...
    <div class="topnav">
        <a class="active" href="Nurse.php">Home</a>
        <a href="hospital5.php">Hospital</a>
        <a class="dactive" href="Main.php">Exit</a>
        <div class="search-container">
        <form action="phpSearchNurse.php" method="POST">
	...
	<main>
		...
		<table>
			<tr>
				...
				<td>
					<button id="exp" class="exp"><a href="innerNursedetails.php">Click Here To Update</a></button>
				</td>
            </tr>
		</table>
		</center>
